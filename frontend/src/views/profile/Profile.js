...
export default function Profile() {
  ...
  function submitting(){
    setSubmit({newFirstName , newLastName});
    navigate("/");
  }
  return (
    <div>
      ...
      <div className="w-full bg-[#F6F5F4] flex flex-col px-[20%] py-[30px] mt-[60px]">
        ...
        <div className="bg-white px-[5%] py-[30px]  flex flex-col rounded-lg items-center w-[90%]">
          ...
          ></img>
          <button className="w-[70px] bg-[#cccccc] h-[70px] rounded-full absolute mt-[170px] ml-[120px]">
            <svg
          ...
          {/* submit */}
          <button className="bg-[#2B788B] rounded-full w-[80%] my-[20px] py-[5px]">
